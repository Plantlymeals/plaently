...
export const MagicLinkEmail = ({
  ...
  <Html lang="sv" dir="ltr">
    <Head />
    <Preview>Din inloggningslänk för PLÄNTLY</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Klicka på knappen nedan för att logga in på PLÄNTLY. Länken upphör snart att gälla.
        </Text>
        <Button style={button} href={confirmationUrl}>
          Logga in
        </Button>
        <Text style={footer}>
          Om du inte begärde den här länken kan du ignorera det här meddelandet.
        </Text>
      </Container>
    </Body>
  </Html>
