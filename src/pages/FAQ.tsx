...
const FAQPage = () => {
  ...
  return (
    <Layout>
      <SEOHead title="Vanliga frågor — PLÄNTLY" description="Svar på vanliga frågor om PLÄNTLY:s plantbaserade proteinmåltider, leverans, ingredienser och mer." path="/faq" />
