      ...
      <section className="py-12 md:py-20">
        <div className="container max-w-3xl space-y-12">
          <div className="text-center space-y-4 animate-fade-up">
            <h1 className="font-heading text-4xl md:text-5xl font-bold">Vanliga frågor</h1>
            <p className="text-muted-foreground text-lg">Vanliga frågor om PLÄNTLY-måltider.</p>
          </div>
