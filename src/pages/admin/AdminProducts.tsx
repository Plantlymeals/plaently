        ...
        <div className="grid lg:grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: sanitizeHtml(translateProductHtml(previewInput, "sv")) }}
            />
          </div>
        </div>
        <div className="grid lg:grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: sanitizeHtml(translateProductHtml(previewInput, "en")) }}
            />
          </div>
          <div className="space-y-1">
