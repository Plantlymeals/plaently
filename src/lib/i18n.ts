...
"ps.ctaBundles": { sv: "Välj ditt paket ↓", en: "Choose your pack ↓" },
 ...
 "newsletter.submit": { sv: "Hämta min kod", en: "Get my code" },
 ...
 "offer.codeHint": { sv: "Använd koden i kassan. Gäller ett Starter Pack, en gång.", en: "Use the code at checkout. Valid for one Starter Pack, once." },
 "offer.alreadyClaimed": { sv: "Du har redan använt ditt erbjudande", en: "You have already used your offer" },
 "offer.alreadyClaimedDesc": { sv: "Den här e-postadressen har redan fått en kod.", en: "This email address has already received a code." },
 "offer.soldOut": { sv: "Erbjudandet är slut för den här omgången", en: "The offer is sold out for this round" },
 "offer.soldOutDesc": { sv: "Alla 500 koder är utfärdade. Håll utkik efter nästa omgång.", en: "All 500 codes have been issued. Watch out for the next round." },
 "offer.rateLimited": { sv: "För många försök", en: "Too many attempts" },
 "offer.rateLimitedDesc": { sv: "Försök igen om en stund.", en: "Please try again in a little while." },
 "offer.error": { sv: "Något gick fel", en: "Something went wrong" },
 "offer.errorDesc": { sv: "Vi kunde inte skapa din kod just nu. Försök igen senare.", en: "We could not create your code right now. Please try again later." },
 ...
 "quiz.loading": { sv: "Laddar…", en: "Loading…" },
  ...
  "quiz.emailDesc": { sv: "Ange din e-post så får du din matchning + din personliga kod för Starter Pack till 199 kr.", en: "Enter your email to get your match + your personal code for the Starter Pack at 199 kr." },
