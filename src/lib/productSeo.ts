...
const PRODUCT_SEO: Record<string, ProductSeoEntry> = {
  ...
  "bolognese-box-12-cups": {
    ...
    de: { title: "Bolognese Box 12 Cups – 20g Protein | PLÄNTLY", description: "Für alle, die italienisches Comfort Food lieben. 12 Portionen mit vollmundigem Geschmack und 20 g Protein pro Mahlzeit." },
  ...
  "carbonara-box-12-cups": {
    ...
    de: { title: "Carbonara Box 12 Cups – 20g Protein | PLÄNTLY", description: "Cremig, proteinreich und in 5 Minuten fertig. 12 Portionen mit 20 g Protein pro Mahlzeit. Enthält Milch." },
  ...
  "smoky-lentils-box-12-cups": {
    ...
    de: { title: "Smoky Lentils Box 12 Cups – 21g Protein | PLÄNTLY", description: "Rauchig, sättigend und voller pflanzlicher Kraft. 12 Portionen mit 21 g Protein pro Mahlzeit." },
  ...
  "yellow-curry-box-12-cups": {
    ...
    de: { title: "Yellow Curry Box 12 Cups – 20g Protein | PLÄNTLY", description: "Wärmende Gewürze und ausgewogene Energie in jeder Portion. 12 Portionen mit 20 g Protein pro Mahlzeit. Enthält Milch." },
